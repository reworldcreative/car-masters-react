...
module.exports = class FontfacegenWebpackPlugin {
  ...
  generateFontWeight(fontname) {
    ...
    } else if (fontname.includes("Regular")) {
      return 400;
    } else if (fontname.includes("ExtraBold")) {
      return 800;
  ...
  generateFontFaceStyles(fontname) {
    ...
    const fontWeight = this.generateFontWeight(fontname);

    let cleanFontname = fontname.replace(/-.*/, "");
    const fontFace = `\n@font-face {
